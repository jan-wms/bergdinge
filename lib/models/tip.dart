...
class Tip {
  ...
  Tip({required this.title, required this.imagePath, required this.subTitle, required this.relevantSports, required this.condition, }) : assert(relevantSports.every((element) => Sports.sports.contains(element)));
