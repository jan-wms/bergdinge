                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: article.color, style: BorderStyle.solid, width: 4.0),
                        boxShadow: [
                          BoxShadow(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: article.color,
                        borderRadius: const BorderRadius.only(topLeft: Radius.circular(16.0), bottomRight: Radius.circular(16.0)),
                      ),
                      child: Text(
                        article.subTitle,
                        style: const TextStyle(
