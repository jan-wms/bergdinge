...
class _SetNameState extends State<SetName> {
  ...
  Future<void> preLoadName() async {
    try {
      ...
      debugPrint('Could not preload name.');
    }
  }
          ...
          Expanded(
            child: Container(
              ...
              child: Row(
                ...
                crossAxisAlignment: MediaQuery.of(context).size.width > Design.wideScreenBreakpoint ? CrossAxisAlignment.start : CrossAxisAlignment.end,
                children: [
                  if(context.canPop())
                    TextButton(
