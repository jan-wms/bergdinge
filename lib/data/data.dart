...
class Data {
  ...
  static List<Article> articles = <Article>[
    Article(
      ...
      content: const [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Gewichtsverteilung', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16.0),),
              Text(
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Packordnung', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16.0),),
              Text(
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Vermeidung von äußeren Anbringungen', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16.0),),
              Text(
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Gleichmäßige Gewichtsverteilung', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16.0),),
              Text(
  ...
  static List<Tip> tips = [
    Tip(
        imagePath: 'items/1.9.1.png',
        title: 'LVS Ausrüstung',
        subTitle:
            'Denke auf Skitour immer an deine LVS Ausrüstung: LVS-Gerät, Sonde und Schaufel.',
        relevantSports: ['Skitour'],
        condition: (items, equipmentList) {
          bool lvs = items?.indexWhere((element1) =>
                  equipmentList
                      .singleWhere(
                          (element2) => element1.equipmentId == element2.id)
                      .category ==
                  '1.3.1.0') !=
              -1;
          bool shovel = items?.indexWhere((element1) =>
                  equipmentList
                      .singleWhere(
                          (element2) => element1.equipmentId == element2.id)
                      .category ==
                  '1.3.1.1') !=
              -1;
          bool pole = items?.indexWhere((element1) =>
                  equipmentList
                      .singleWhere(
                          (element2) => element1.equipmentId == element2.id)
                      .category ==
    ...
    Tip(
        ...
        relevantSports: sports,
        condition: (items, equipmentList) {
          return items?.indexWhere((element1) =>
                  equipmentList
                      .singleWhere(
                          (element2) => element1.equipmentId == element2.id)
                      .category ==
    ...
    Tip(
        imagePath: 'items/0.0.4.4.png',
        title: 'Gewicht',
        subTitle:
            'Nimm nur das Nötigste mit, doch spare nicht bei der Sicherheitsausstattung!',
        relevantSports: sports,
        condition: (items, equipmentList) => false),
  ];
      ...
      Category(name: 'Accessories', id: '0.0', subCategories: [
        Category(
            ...
            subCategories: [
              ...
              Category(
                  name: 'Sonstige', id: '0.0.0.4', imageName: '0.0.0.2.png'),
            ]),
          ...
          subCategories: [
            ...
            Category(
              ...
              subCategories: [
                ...
                Category(
                    name: 'Sonstige', id: '1.1.6.3', imageName: '1.1.6.0.png'),
              ],
            ),
            Category(
