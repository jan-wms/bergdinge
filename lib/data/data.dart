...
class Data {
  ...
  static List<Category> categories = [
    ...
    Category(
      name: 'Verpflegung',
      subCategories: [
        Category(name: 'Getränke', id: 183),
        Category(name: 'Nahrung', id: 184),
      ],
      id: 182,
    ),
  ];

  static List<Category> getCategoriyListFromID(
      {required List<Category> pList,
      required List<Category> pResult,
    ...
    for (var element in pList) {
      ...
      if (element.subCategories != null) {
        var r = getCategoriyListFromID(
            pList: element.subCategories!,
            pResult: result,
