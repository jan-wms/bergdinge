...
class SearchHeader extends SliverPersistentHeaderDelegate {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.vertical(
              ...
              top: (MediaQuery.of(context).size.width > Design.wideScreenBreakpoint && MediaQuery.of(context).orientation == Orientation.landscape && !disableRoundedCorners) ? const Radius.circular(20) : Radius.zero,
            )),
        child: Padding(
                      ...
                      decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              ...
                              blurRadius: 10,
                              color: Design.green.withValues(alpha: 0.23),
                            )
                          ]),
                      child: search ??
                          Text(
  ...
  bool shouldRebuild(covariant SearchHeader oldDelegate) {
    return title != oldDelegate.title || subtitle != oldDelegate.subtitle || icon != oldDelegate.icon || search != oldDelegate.search || disableRoundedCorners != oldDelegate.disableRoundedCorners;
  }
